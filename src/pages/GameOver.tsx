  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0d0221]">
      ...
      <div className="relative z-10 text-center max-w-lg mx-auto px-6">
        ...
        {/* Story */}
        <div className="bg-[#1e1145]/60 border border-purple-500/15 rounded-xl p-5 mb-6 animate-slide-up" style={{ animationDelay: "0.1s" }}>
          <p className="text-white/50 text-base italic">
            "The security lockdown seals shut with a thunderous boom. The Cloud Guardian's voice echoes through the darkness: 'You weren't fast enough, traveler. The data center claims another soul. But perhaps... you'd like to try again?'"
          </p>
        </div>

        <p className="text-white/25 text-sm mb-8 animate-slide-up" style={{ animationDelay: "0.15s" }}>
          You reached Room {roundReached} of 3
        </p>
